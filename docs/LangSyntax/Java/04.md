...
참조 자료형에는 크게 Class, Interface, Array의 4가지가 있다.<sup>[Java](https://docs.oracle.com/javase/specs/jls/se18/html/jls-4.html#jls-4.3 "Java Language Specification")</sup>
<table>
    <tr>
        <th>종류</th>
        <th>예시</th>
